// CALL THE PACKAGES --------------------
var User = require('../models/user'); // for working w/ our users back a level
var jwt = require('jsonwebtoken');

// TC change to make more modular
var config = require('../../config');	// import settings from config.js

// TODO: need to remove this and replace all superSecret with 'config.secret'
